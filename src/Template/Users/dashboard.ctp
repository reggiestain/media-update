                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><?php echo $this->Html->image('avatar/1.jpg', array('alt' => 'avatar')); ?></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><?php echo $this->Html->image('avatar/2.jpg', array('alt' => 'Avatar 2')); ?></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                                <span class="photo media-left"><?php echo $this->Html->image('avatar/3.jpg', array('alt' => 'Avatar 3')); ?></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><?php echo $this->Html->image('avatar/4.jpg', array('alt' => 'Avatar 4')); ?></span>
                                <span class="message media-body">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?php echo $this->Html->image('admin.jpg', array('alt' => 'User Avatar','class'=>'user-avatar rounded-circle')); ?>
                        </a>
           ...
           <div class="col-xl-3 col-lg-6">
                <section class="card">
                    <div class="twt-feed blue-bg">
                        ...
                        <div class="media">
                            <a href="#">
                                <?php echo $this->Html->image('avatar/4.jpg', array('alt' => 'amin','class'=>'align-self-center rounded-circle mr-3','style'=>'width:85px; height:85px;')); ?>
